...
const PHILOSOPHY = [
  ...
  },
  {
    ...
    title: 'Ajan Tabanlı Yönetim',
    description: 'Sadece veri girişi yapmazsınız, yanınızda uzman bir ekip varmış gibi çalışırsınız.',
    detail: 'Satis, Stok ve Cari ajanlarımız arka planda kuralları denetler, anomalileri bulur ve sizi uyarır.'
  },
  {
  ...
  },
  {
    ...
    description: 'Karmaşık ERP sistemlerini değil, herkesin kolayca kullanabileceği modern bir deneyimi hedefliyoruz.',
...
export default function About() {
  return (
    <div className=\"max-w-5xl mx-auto p-6 space-y la-12\">
