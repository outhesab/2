  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ color: 'var(--text-dim)', fontSize: '0.78rem', fontWeight: 600 }}>Sağlık Skoru</div>
      </div>
      <div
        style={{
      ...
      >
        ...
        <div style={{ color: 'var(--text-dim)', fontSize: '0.78rem', fontWeight: 600 }}>Kritik</div>
      </div>
      <div
        style={{
      ...
      >
        ...
        <div style={{ color: 'var(--text-dim)', fontSize: '0.78rem', fontWeight: 600 }}>Uyarı</div>
      </div>
      <div
        style={{
      ...
      >
        ...
        <div style={{ color: 'var(--text-dim)', fontSize: '0.78rem', fontWeight: 600 }}>Bilgi</div>
      </div>
      <div
        style={{
      ...
      >
        <div style={{ fontSize: '2rem', fontWeight: 900, color: '#ff5722' }}>{alertCount}</div>
        <div style={{ color: 'var(--text-dim)', fontSize: '0.78rem', fontWeight: 600 }}>Aktif Alarm</div>
      </div>
    </div>
  );
}
