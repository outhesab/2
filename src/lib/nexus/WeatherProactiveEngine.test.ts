    ...
    const db = makeTestDB({
      sales: [
        makeSale({
          ...
          items: [
            { productId: 'p1', productName: 'Soba 80lik', quantity: 10, unitPrice: 5000, cost: 4000, total: 5000 },
          ],
        }),
      ],
    });
    ...
    const db = makeTestDB({
      sales: [
        makeSale({
          ...
          deleted: true,
          items: [
            { productId: 'p1', productName: 'Soba 80lik', quantity: 5, unitPrice: 5000, cost: 4000, total: 5000 },
          ],
        }),
      ],
    });
    ...
    for (let i = 0; i < 30; i++) {
      ...
      sales.push(
        makeSale({
          ...
          createdAt: d.toISOString(),
          items: [
            { productId: 'p1', productName: 'Soba 80lik', quantity: 2, unitPrice: 5000, cost: 4000, total: 5000 },
          ],
        }),
      );
    }
    ...
    for (let i = 0; i < 30; i++) {
      ...
      sales.push(
        makeSale({
          ...
          createdAt: d.toISOString(),
          items: [
            { productId: 'p1', productName: 'Soba 80lik', quantity: 3, unitPrice: 5000, cost: 4000, total: 5000 },
          ],
        }),
      );
    }
