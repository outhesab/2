...
export const CHANGELOG: VersionEntry[] = [
  {
    ...
    changes: [
      ...
      {
        type: 'duzeltme',
        text: 'App.tsx: React Rules of Hooks ihlali düzeltildi — isDBReady erken return kontrolü tüm useEffect çağrılarından sonraya taşındı (production StrictMode console.error + state tutarsızlığı riski giderildi)',
      },
    ],
  },
  {
