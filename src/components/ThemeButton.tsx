...
export function ThemeButton({ accent, bg, label, desc, isLight, isActive, onSelect }: ThemeButtonProps) {
  return (
    <button
      onClick={onSelect}
      style={{
    ...
    >
      ...
      <div className="text-[var(--text-dim)] text-[0.7rem] mt-0.5">{desc}</div>
      {isActive && (
        <div
          style={{
            position: 'absolute',
