...
export function SkeletonStatCard() {
  return (
    <div className="skeleton-stat skeleton" style={{ minWidth: 170, flex: '0 0 auto' }}>
...
export function SkeletonDetail() {
  return (
    <div style={{ padding: 24 }}>
      <SkeletonBlock className="skeleton-heading" style={{ height: 24, width: '35%', marginBottom: 24 }} />
