...
export function getAgent(id: AgentId): AnyAgent {
  if (!_agents[id]) {
    switch (id) {
      case 'stok':
        _agents[id] = new StokAgent();
        break;
      case 'kasa':
        _agents[id] = new KasaAgent();
        break;
      case 'satis':
        _agents[id] = new SatisAgent();
        break;
      case 'cari':
        _agents[id] = new CariAgent();
        break;
      case 'fatura':
        _agents[id] = new FaturaAgent();
        break;
      case 'rapor':
        _agents[id] = new RaporAgent();
        break;
      case 'deep_seek':
        _agents[id] = new DeepSeekAgent();
        break;
    }
  }
  return _agents[id];
