...
### PR Description Checklist (Zorunlu)

Her PR description'ı aşağıdaki maddeleri içermelidir:

- [ ] Satır sayıları (`wc -l` çıktısı veya eşdeğeri)
- [ ] Yeni dosyaların listesi + satır sayıları
- [ ] Değişen ve değişmeyen dosyalar ayrı ayrı listelenmiş
- [ ] Yeni claim'lerin kanıtı (test sonucu, çalıştırma çıktısı vb.)
- [ ] "Yapıldı" denilen her şey için PR içinde referans (commit SHA, dosya:satır)
...
**Son güncelleme:** 23 Haziran 2026 · v3.43.0
